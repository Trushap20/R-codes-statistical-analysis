#######################################################
#                  Applied Project No. 1              #   
#     Introduction of  Deep Neural Networks and its   #
#                   application using R               #
#                                                     #
#                                                     #
#Name	                            Matriculation Number#                            
#Trusha Patel 	                   6872844 Part 2 & 3 #
#Kangana Makkar	                   6873174 Part 1     # 
#Siying Yao                        6865420 Part 3     # 
#######################################################


####################PART 2#############################

data<- read.csv(file="C:/Users/49176/OneDrive/Desktop/Summer 2022/housing.csv")
library(dplyr)
library(neuralnet)
library(Metrics)
